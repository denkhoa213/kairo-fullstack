      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-primary p-12 relative overflow-hidden">
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center gap-8 py-12">
          <div className="relative w-full max-w-sm">
            ...
            <div
              className="absolute top-8 right-0 w-56 h-32 bg-white/20 backdrop-blur-sm rounded-2xl border border-white/30 flex flex-col items-center justify-center gap-2 animate-float"
            ...
            <div
              className="mt-32 bg-white/15 backdrop-blur-sm rounded-2xl border border-white/20 p-5 animate-float"
        ...
        <div className="relative">
          <blockquote className="text-white/80 text-sm italic leading-relaxed">
            "Việc học không bao giờ làm mệt mỏi trí óc. Chỉ có việc bị ép buộc
            học mới làm vậy."
          </blockquote>
